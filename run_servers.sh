...
gnome-terminal --window -e '/bin/bash -c "go run -race overdb.go -- kv 0 0;exec bash"'
gnome-terminal --window -e '/bin/bash -c "go run -race overdb.go -- kv 0 1;exec bash"'
gnome-terminal --window -e '/bin/bash -c "go run -race overdb.go -- kv 0 2;exec bash"'
